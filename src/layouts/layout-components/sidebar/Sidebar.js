...
const Sidebar = (props) => {
  ...
  const [state, setState] = useState({
    bdsettingpages: activeRoute("/bigdata-settings") !== "" ? true : false,
    bdreportpages: activeRoute("/bigdata-reports") !== "" ? true : false,
    hssettingpages: activeRoute("/hotspot-settings") !== "" ? true : false,
    hsreportpages: activeRoute("/hotspot-reports") !== "" ? true : false,
    locationpages: activeRoute("/maintenances") !== "" ? true : false,
  });
